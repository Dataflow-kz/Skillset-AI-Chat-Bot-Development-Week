...
## 📝 Описание проекта
Добро пожаловать в Skillset AI Chat Bot Development Week! Это 9-дневный челлендж, направленный на изучение основ разработки программного обеспечения через создание AI чат-ботов с использованием Gemini AI.
...
### День 3-4: Создание базового Telegram бота
...
### День 7-8: Интеграция дополнительного API
...
### День 9: Финальное тестирование и документация
